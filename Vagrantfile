...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "dcollazo-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/1980"
  #   chef.validation_client_name = "1980-validator"
  #   chef.validation_key_path = ".chef/1980-validator.pem"
  # end
end
